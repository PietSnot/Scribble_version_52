 ...
 * @author Sylvia
 */
public class ScribbleEllipse implements ScribbleShape {
    ...
    // Factory methodes
    //==============================================
    public ScribbleEllipse setStrokeWidth(double strokeWidth) {
        this.strokeWidth = (float) strokeWidth;
        return this;
    }
    
    public ScribbleEllipse setColor(Color color) {
        this.color = color;
        return this;
    }
