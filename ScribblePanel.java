...
class ScribblePanel extends JPanel {
    ...
    final private ScribblePanelsViewer viewer;
    Color color;
   ...
   // and a reference to itself, to save some typing
    ...
    //======================================================
    public ScribblePanel(ScribblePanelsViewer viewer, int width, int height) {
        this.viewer = viewer;
        ...
        mouseAdapterForShapes = new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent m) {
                currentShape = viewer.getShape();
                color = viewer.getColor();
